...
import com.example.dotogether.databinding.FragmentPendingTargetsBinding
...
@AndroidEntryPoint
class PendingTargetsFragment : BaseFragment(), HolderListener.TargetHolderListener {

    private val viewModel: LibraryViewModel by viewModels()
    private lateinit var binding: FragmentPendingTargetsBinding
    ...
    private val scrollListener = object : RecyclerView.OnScrollListener() {
        override fun onScrollStateChanged(recyclerView: RecyclerView, newState: Int) {
            ...
            if(!recyclerView.canScrollVertically(1)) {
                viewModel.getNextMyJoinedTargets(nextPage)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = FragmentPendingTargetsBinding.inflate(layoutInflater)
